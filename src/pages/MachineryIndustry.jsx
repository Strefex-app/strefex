...
import './MachineryIndustry.css'

const MachineryIndustry = () => {
    ...
    <AppLayout>
      <div className="app-page">
        <div className="app-page-card">
          ...
          <h2 className="app-page-title">Machinery Industry</h2>
          <p className="app-page-subtitle">Supplier audit and compliance.</p>
        </div>
