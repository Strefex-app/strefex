  ...
  nuclear: [
    {
      ...
      subcategories: [
        ...
        { id: 'ica-instrumentation', name: 'I&C components & sensors', description: 'Transmitters, position indication, safety-related instrumentation assemblies' },
      ],
    },
    {
      id: 'nuclear-oem-manufacturing',
      name: 'Nuclear-related equipment manufacturing',
      description: 'OEM, sub-supply, and contract manufacturing for nuclear-qualified and safety-class equipment',
      color: '#37474f',
      subcategories: [
        { id: 'precision-machining-nuclear', name: 'Precision machining & fabrications', description: 'CNC, large turning, and weldments produced under nuclear QA programs' },
        { id: 'module-skid-build', name: 'Modules, skids & packaged systems', description: 'Mechanical assembly, cabling, FAT and dossier support for delivered systems' },
        { id: 'clean-controlled-assembly', name: 'Clean / controlled assembly', description: 'Controlled environments for safety-related mechanical and electromechanical builds' },
      ],
    },
    {
      id: 'pipes-piping-systems',
      name: 'Pipes, piping & fittings',
      description: 'Pipe, tube, fittings, flanges, and specialty connections for nuclear fluid systems',
      color: '#1565c0',
      subcategories: [
        { id: 'pipe-tube-mill', name: 'Pipe & tube (seamless / welded)', description: 'Carbon, stainless, and alloy piping to nuclear procurement specifications' },
        { id: 'fittings-flanges', name: 'Fittings, flanges & olets', description: 'Butt-weld and threaded fittings, flanges, branch connections' },
        { id: 'small-bore-specialty', name: 'Small-bore & specialty tubing', description: 'Instrumentation tubing, heat-exchanger tubes, coiled and precision tube' },
        { id: 'valves-flow', name: 'Valves & flow hardware', description: 'Isolation, control, and check valves supplied with nuclear documentation' },
      ],
    },
    {
      id: 'materials-mill-products',
      name: 'Materials & mill products',
      description: 'Plate, bar, structurals, forgings, and weld consumables with full material attestations',
      color: '#6a1b9a',
      subcategories: [
        { id: 'plate-bar-structural', name: 'Plate, bar & structural', description: 'Rolled plate, rounds, flats, and shapes for nuclear pressure boundary and supports' },
        { id: 'forgings-castings', name: 'Forgings & castings', description: 'Rough and finish-machined rough forgings and cast parts with heat codes' },
        { id: 'specialty-alloys', name: 'Specialty alloys & clad products', description: 'Nickel alloys, duplex, clad plate, and corrosion-resistant grades' },
        { id: 'weld-consumables', name: 'Weld consumables & flux', description: 'Electrodes, wire, flux, and backing for qualified nuclear weld procedures' },
      ],
    },
    {
      id: 'spare-parts-consumables',
      name: 'Spare parts & shop consumables',
      description: 'Maintenance spares, wear parts, seals, and general consumables for nuclear facilities and suppliers',
      color: '#c62828',
      subcategories: [
        { id: 'mechanical-spares', name: 'Mechanical spares', description: 'Bearings, bushings, couplings, fasteners, and replaceable wear components' },
        { id: 'seals-gaskets-packing', name: 'Seals, gaskets & packing', description: 'Gaskets, O-rings, mechanical seals, and valve packing for fluid systems' },
        { id: 'filters-strainers', name: 'Filters & strainers', description: 'Process and HVAC filters, basket and inline strainer elements' },
        { id: 'mro-consumables', name: 'MRO & industrial consumables', description: 'Abrasives, cutting tools, lubricants, and general maintenance supplies under program control' },
      ],
    },
  ],
}
