-- ============================================================
-- Expose search_suppliers RPC to PostgREST (Buyer workspace)
-- ============================================================
-- Fixes: "Could not find the function public.search_suppliers(...) in the schema cache"
...
COMMENT ON FUNCTION public.search_suppliers(
  TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, INTEGER, INTEGER
) IS 'Buyer workspace supplier search; exposed to PostgREST for rpc.';
